...
import KishorePhoto from '../assets/KishorePhoto.jpg'
						...
						<div className="generalInformation">
							...
							<div className="aboutUsIcons">
								...
								<a
									className="aboutMeLink"
									onClick={(event) =>
										openLinkedInLink(event, NATHAN_LINKEDIN_URL)
									}
									target="_blank"
								>
									<svg
                ...
                <div className="imageIconDisplay">
						...
						<div className="generalInformation">
							...
							<div className="aboutUsIcons">
								<a
									className="aboutMeLink"
									onClick={(event) => openGithubLink(event, KISHORE_GITHUB_URL)}
									target="_blank"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
								...
								<a
									className="aboutMeLink"
									onClick={(event) =>
										openLinkedInLink(event, KISHORE_LINKEDIN_URL)
									}
									target="_blank"
								>
									<svg
